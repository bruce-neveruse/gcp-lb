...
#CLOUD ARMOUR POLICY
gcloud compute  security-policies create hm-access --description="only allow 157.154.3.140, 167.164.3.140, lab proxy 157.154.3.241, and home network"
...
gcloud compute  security-policies rules update 2147483647 --action=deny-403 --security-policy=hm-access --description="Default rule, higher priority overrides it" --src-ip-ranges=157.154.3.140,167.164.3.140,157.154.3.241,152.208.2.117
