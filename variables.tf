variable "credentials" { default = "/mnt/c/Users/lidv280/Downloads/playground-s-11-e8123af2-fe811369abf5.json" }
variable "gcp_project_id" { default = "playground-s-11-e8123af2" }
